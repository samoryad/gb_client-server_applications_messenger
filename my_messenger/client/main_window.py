...
from my_messenger.client.add_contact import AddContactDialog
from my_messenger.client.del_contact import DelContactDialog
from my_messenger.client.main_window_conv import Ui_MainWindow
...
class ClientMainWindow(QMainWindow):
    ...
    def message(self, message):
        ...
        encrypted_message = base64.b64decode(message[CONFIGS.get('MESSAGE_TEXT')])
